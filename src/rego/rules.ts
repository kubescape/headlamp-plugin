...
export const rules: Rule[] = [
  {
    ...
    attributes: {
      m$K8sThreatMatrix:
        'Credential Access::Access container service account, Lateral Movement::Container service account',
    ...
    ruleDependencies: [],
    description:
      'determines which service accounts can be used to access other resources in the cluster',
    remediation: '',
    ...
    dynamicMatch: [
      {
        ...
        apiVersions: ['v1beta0'],
        resources: ['KubeletInfo'],
      },
    ],
    ruleDependencies: [],
    description: 'Determines if the --protect-kernel-defaults argument is set to true.',
    remediation:
      'Set --protect-kernel-defaults to true or if using a config file set the protectKernelDefaults as true',
    ruleQuery: '',
  ...
  },
  {
    ...
    dynamicMatch: [
      {
        apiGroups: ['container.googleapis.com', 'eks.amazonaws.com'],
        apiVersions: ['v1'],
        resources: ['ClusterDescribe'],
      },
    ],
  ...
  },
  {
    ...
    dynamicMatch: [
      {
        apiGroups: ['apiserverinfo.kubescape.cloud'],
        apiVersions: ['v1beta0'],
        resources: ['APIServerInfo'],
      },
    ],
    ruleDependencies: [],
    description:
      'List aggregated API server APIServices if kube-api-server version is vulnerable to CVE-2022-3172',
    remediation:
      'Upgrade the Kubernetes version to one of the fixed versions. The following versions are fixed: `v1.25.1`, `v1.24.5`, `v1.23.11`, `v1.22.14`',
    ruleQuery: '',
    ...
    match: [
      {
        apiGroups: ['rbac.authorization.k8s.io'],
        apiVersions: ['v1'],
        resources: ['Role', 'ClusterRole', 'ClusterRoleBinding', 'RoleBinding'],
      },
    ],
    ruleDependencies: [],
  ...
  },
  {
    ...
    dynamicMatch: [
      {
        apiGroups: ['armo.vuln.images', 'image.vulnscan.com'],
        apiVersions: ['v1'],
        resources: ['ImageVulnerabilities'],
      },
    ],
    description:
      'fails if known pods have exposed services and known vulnerabilities with remote code execution',
    remediation:
      'The image of the listed pods might have a fix in a newer version. Alternatively, the pod service might not need to be external facing',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Make sure that you definy resource policies (LimitRange or ResourceQuota) which limit the usage of resources for all the namespaces',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Checks that every namespace enabled baseline pod security admission, or if there are external policies applied for namespaced resources (validating/mutating webhooks) - returns them to be reviewed',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Set --event-qps argument to appropiate level or if using a config file set the eventRecordQPS property to the value other than 0',
    ruleQuery: '',
  ...
  },
  {
    ...
    dynamicMatch: [
      {
        apiGroups: ['management.azure.com'],
        apiVersions: ['v1'],
        resources: ['ClusterDescribe'],
      },
    ],
  ...
  },
  {
    ...
    match: [
      ...
      },
      {
        ...
        apiVersions: ['*'],
        resources: ['HTTPRoute', 'TCPRoute', 'UDPRoute'],
      },
    ],
    description:
      'fails if the running workload is bound to a Service that is exposed to the Internet through a Gateway.',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    attributes: {
      m$K8sThreatMatrix:
        'Lateral Movement::Access Kubernetes dashboard, Discovery::Access Kubernetes dashboard',
      resourcesAggregator: 'subject-role-rolebinding',
      useFromKubescapeVersion: 'v1.0.133',
    },
    ruleLanguage: 'Rego',
    ...
    ruleDependencies: [],
    description:
      'fails if subject that is not dashboard service account is bound to dashboard role/clusterrole, or- if anyone that is not dashboard pod is associated with its service account.',
    remediation: '',
  ...
  },
  {
    ...
    remediation:
      'Make sure that the allowPrivilegeEscalation field in the securityContext of pod/container is set to false',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    description:
      'fails in case the running workload has binded Service or Ingress that are exposing it on Internet.',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Fails in system:authenticated user has cluster takeover rbac permissions (is bound by a RoleBinding/ClusterRoleBinding)',
  ...
  },
  {
    ...
    ruleDependencies: [],
    configInputs: ['settings.postureControlInputs.k8sRecommendedLabels'],
    controlConfigInputs: [
      {
  ...
  },
  {
    ...
    remediation:
      'Make sure that the automountServiceAccountToken field on the service account spec if set to false',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Make sure that the user/group in the securityContext of pod/container is set to an id over 0, or the runAsNonRoot flag is set to true.',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Make sure that the securityContext.readOnlyRootFilesystem field in the container/pod spec is set to true',
    ruleQuery: 'armo_builtins',
    ...
    dynamicMatch: [
      {
        apiGroups: ['management.azure.com'],
        apiVersions: ['v1'],
        resources: ['ListEntitiesForPolicies'],
      },
    ],
    relevantCloudProviders: ['AKS'],
    ruleDependencies: [],
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Fails in case anonymous or unauthenticated user has any rbac permissions (is bound by a RoleBinding/ClusterRoleBinding)',
  ...
  },
  {
    ...
    configInputs: ['settings.postureControlInputs.sensitiveInterfaces'],
    controlConfigInputs: [
      {
  ...
  },
  {
    ...
    remediation:
      'Make sure you define  at least one linux security hardening property out of Seccomp, SELinux or Capabilities.',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Containers should be as isolated as possible from the host machine. The hostIPC field in Kubernetes may excessively expose the host to potentially malicious actions.',
    remediation:
      'Make sure that the field hostIPC in the pod spec is not set to true (set to false or not present)',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    match: [
      ...
      },
      {
        ...
        resources: ['VirtualService', 'Gateways'],
      },
    ],
    description:
      'fails if the running workload is bound to a Service that is exposed to the Internet through Istio Gateway.',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Disable anonymous requests by setting  the anonymous-auth flag to false, or using the kubelet configuration file.',
    ruleQuery: '',
    ...
    match: [
      {
        apiGroups: ['*'],
        apiVersions: ['*'],
        resources: ['Namespace', 'ServiceAccount'],
      },
    ],
    ruleDependencies: [],
  ...
  },
  {
    ...
    attributes: {
      m$K8sThreatMatrix:
        'Credential access::Applications credentials in configuration files, Lateral Movement::Applications credentials in configuration files',
    },
    ruleLanguage: 'Rego',
    match: [
      {
    ...
    dynamicMatch: [
      {
        apiGroups: ['eks.amazonaws.com'],
        apiVersions: ['v1'],
        resources: ['DescribeRepositories'],
      },
    ],
    relevantCloudProviders: ['EKS'],
    ruleDependencies: [],
  ...
  },
  {
    ...
    description:
      'Due to the difficulty of performing a good check, the review is left manual to the user.',
    remediation: '',
    ruleQuery: '',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Determines if the Kubelet is configured to only use strong cryptographic ciphers.',
    remediation:
      'Change --tls-cipher-suites value of TLSCipherSuites property of config file to use strong cryptographics ciphers',
    ruleQuery: '',
    ...
    dynamicMatch: [
      {
        apiGroups: ['hostdata.kubescape.cloud'],
        apiVersions: ['v1beta0'],
        resources: ['cloudProviderInfo'],
      },
    ],
    ruleDependencies: [],
    description:
      'Checks if there is access from the nodes to cloud prividers instance metadata services',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    attributes: {
      m$K8sThreatMatrix:
        'Persistence::Writable hostPath mount, Lateral Movement::Writable volume mounts on the host',
    },
    ruleLanguage: 'Rego',
    match: [
      {
  ...
  },
  {
    ...
    remediation:
      'Change value of a --streaming-connection-idle-timeout argument or if using a Kubelet config file, edit the file to set streamingConnectionIdleTimeout to a value other than 0.',
    ruleQuery: '',
  ...
  },
  {
    ...
    dynamicMatch: [
      {
        apiGroups: ['hostdata.kubescape.cloud'],
        apiVersions: ['v1beta0'],
        resources: ['KubeletConfiguration', 'KubeletCommandLine'],
      },
    ],
    ruleDependencies: [],
    description:
    ...
    remediation:
      'Start the kubelet with the --tls-cert-file and --tls-private-key-file flags, providing the X509 certificate and its matching private key or if using config file set tlsCertFile and tlsPrivateKeyFile properties to the locations of the corresponding files.',
    ruleQuery: '',
  ...
  },
  {
    ...
    remediation:
      'Enable Azure Defender image scanning. Command: az aks update --enable-defender --resource-group <your-resource-group> --name <your-cluster-name>',
    ...
    match: [
      {
        apiGroups: ['*'],
        apiVersions: ['*'],
        resources: ['Role', 'ClusterRole', 'ClusterRoleBinding'],
      },
    ],
    ruleDependencies: [
      {
    ...
    dynamicMatch: [
      {
        apiGroups: ['hostdata.kubescape.cloud'],
        apiVersions: ['v1beta0'],
        resources: ['LinuxKernelVariables'],
      },
    ],
    ruleDependencies: [],
    description: '',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Containers should be as isolated as possible from the host machine. The hostPID and hostIPC fields in Kubernetes may excessively expose the host to potentially malicious actions.',
    remediation:
      'Make sure that the fields hostIPC and hostPID in the pod spec are not set to true (set to false or not present)',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    attributes: {
      m$K8sThreatMatrix:
        'Lateral Movement::Container internal networking, Discovery::Network mapping',
    },
    ruleLanguage: 'Rego',
    match: [
      {
  ...
  },
  {
    ...
    remediation:
      'Make sure you do not configure hostPort for the container, if necessary use NodePort / ClusterIP',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Make sure that the automountServiceAccountToken field on the default service account spec is set to false',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'Containers should be as isolated as possible from the host machine. The hostPID field in Kubernetes may excessively expose the host to potentially malicious actions.',
    remediation:
      'Make sure that the field hostPID in the pod spec is not set to true (set to false or not present)',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Create necessary deployment object for every Pod making any Pod a first class citizen in your IaC architecture. Example command: kubectl create deployment nginx-depl --image=nginx:1.19',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    configInputs: ['settings.postureControlInputs.recommendedLabels'],
    controlConfigInputs: [
      {
    ...
    description:
      'check if a certain set of labels is defined, this is a configurable control. Initial list: app, tier, phase, version, owner, env.',
    remediation: '',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    ruleDependencies: [],
    description:
      'A user may be able to create a container with subPath volume mounts to access files & directories outside of the volume, including on the host filesystem. This was affected at the following versions: v1.22.0 - v1.22.1, v1.21.0 - v1.21.4, v1.20.0 - v1.20.10, version v1.19.14 and lower. ',
    remediation:
  ...
  },
  {
    ...
    remediation:
      'Make sure that the hostNetwork field of the pod spec is not set to true (set to false or not present)',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Enable Azure RBAC on AKS by using the following command: az aks update -g <resource_group> -n <cluster_name> --enable-azure-rbac',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Make sure you define seccompProfile as RuntimeDefault at workload or container lever.',
    ruleQuery: 'armo_builtins',
  ...
  },
  {
    ...
    remediation:
      'Set --make-iptables-util-chains to true or if using a config file set the makeIPTablesUtilChains as true',
    ruleQuery: '',
