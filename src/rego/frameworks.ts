    ...
    controls: [
      {
        ...
        description:
          'Network is monitored and protected by the following. System firewalls are configured to limit unnecessary ports, protocols and services. Firewall rules are reviewed at least annually by IT management.',
      ...
      },
      {
        ...
        description:
          "Encryption keys used to protect data at rest and in transit are stored and managed in accordance with the organization's cryptography policy. Access to encryption keys are restricted to authorized personnel.",
        remediation: 'Use Kubernetes secrets or Key Management Systems to store credentials.',
        long_description:
          "Encryption keys used to protect data at rest and in transit are stored and managed in accordance with the organization's cryptography policy. Access to encryption keys are restricted to authorized personnel.",
        test: 'Check if the pod has sensitive information in environment variables, by using list of known sensitive key names. Check if there are configmaps with sensitive information.',
      ...
      },
      {
        ...
        description:
          'Administrative access on the in-scope production infrastructure (cloud platform, servers, database) are restricted to authorized users based on job responsibilities.',
        remediation:
          "You should apply least privilege principle. Make sure cluster admin permissions are granted only when it is absolutely necessary. Don't use subjects with such high permissions for daily operations.",
        long_description:
          'Administrative access on the in-scope production infrastructure (cloud platform, servers, database) are restricted to authorized users based on job responsibilities.',
      ...
      },
      {
        ...
        description:
          'Logging is enabled to monitor the following events at the application and/or infrastructure layers.',
        remediation:
          'Turn on audit logging for your cluster. Look at the vendor guidelines for more details',
        long_description:
      ...
      },
      {
        ...
        description:
          "Transport Layer Security (TLS) is used to protect the transmission of data sent over the internet to and from the organization's application server.",
        remediation:
    ...
    controls: [
      {
        ...
        description: 'Use approved container registries.',
        remediation:
          'If you are using Azure Container Registry you have this option:<https://docs.microsoft.com/en-us/azure/container-registry/container-registry-firewall-access-rules>\n\n For other non-AKS repos using admission controllers or Azure Policy will also work.\n\n Limiting or locking down egress traffic is also recommended:\n<https://docs.microsoft.com/en-us/azure/aks/limit-egress-traffic>',
        long_description:
          'Allowing unrestricted access to external container registries provides the opportunity for malicious or unapproved containers to be deployed into the cluster. Allowlisting only approved container registries reduces this risk.',
        test: 'Checks if image is from allowed listed registry.',
        controlID: 'C-0078',
      ...
      },
      {
        ...
        impact_statement:
          'Pods defined with `spec.containers[].securityContext.privileged: true` will not be permitted.',
        default_value:
          'By default, when you provision an AKS cluster, the value of "enablePodSecurityPolicy" is null.',
        scanningScope: {
          matches: ['EKS'],
        },
        rules: [],
    ...
    controls: [
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261972'],
        impact_statement:
          'Pods defined with `spec.hostNetwork: true` will not be permitted unless they are run under a specific policy.',
        default_value:
          'By default, there are no restrictions on the creation of `hostNetwork` containers.',
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/manifests/kube-apiserver.yaml\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261911'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, the `kube-apiserver.yaml` file has permissions of `640`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/manifests/kube-apiserver.yaml\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261912'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/manifests/kube-controller-manager.yaml\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261913'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/manifests/kube-controller-manager.yaml\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261914'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/manifests/kube-scheduler.yaml\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261915'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `kube-scheduler.yaml` file has permissions of `640`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/manifests/kube-scheduler.yaml\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261917'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `kube-scheduler.yaml` file ownership is set to `root:root`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/manifests/etcd.yaml\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261918'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/manifests/etcd.yaml\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261920'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a <path/to/cni/files>\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261922'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'NA',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G <path/to/cni/files>\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261923'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'NA',
      ...
      },
      {
        ...
        manual_test:
          'On the etcd server node, get the etcd data directory, passed as an argument `--data-dir`, from the below command:\n\n \n```\nps -ef | grep etcd\n\n```\n Run the below command (based on the etcd data directory found above). For example,\n\n \n```\nstat -c %a /var/lib/etcd\n\n```\n Verify that the permissions are `700` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261924'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default, etcd data directory has permissions of `755`.',
      ...
      },
      {
        ...
        manual_test:
          'On the etcd server node, get the etcd data directory, passed as an argument `--data-dir`, from the below command:\n\n \n```\nps -ef | grep etcd\n\n```\n Run the below command (based on the etcd data directory found above). For example,\n\n \n```\nstat -c %U:%G /var/lib/etcd\n\n```\n Verify that the ownership is set to `etcd:etcd`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261926'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default, etcd data directory ownership is set to `etcd:etcd`.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261927'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261929'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None.',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the following command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/scheduler.conf\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261931'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `scheduler.conf` has permissions of `640`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/scheduler.conf\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261933'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `scheduler.conf` file ownership is set to `root:root`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %a /etc/kubernetes/controller-manager.conf\n\n```\n Verify that the permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261939'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `controller-manager.conf` has permissions of `640`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/controller-manager.conf\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261942'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the below command (based on the file location on your system) on the Control Plane node. For example,\n\n \n```\nls -laR /etc/kubernetes/pki/\n\n```\n Verify that the ownership of all files and directories in this hierarchy is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261946'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261948'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633380/recommendations/4261949'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261951'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'Anonymous requests will be rejected.',
        default_value: 'By default, anonymous access is enabled.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261952'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'You will have to configure and use alternate authentication mechanisms such as certificates. Static token based authentication could not be used.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261960'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'You require TLS to be configured on apiserver as well as kubelets.',
        default_value: 'By default, certificate-based kubelet authentication is not set.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261970'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'You require TLS to be configured on apiserver as well as kubelets.',
        default_value: 'By default, `--kubelet-certificate-authority` argument is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--authorization-mode` argument exists and is not set to `AlwaysAllow`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261973'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'Only authorized requests will be served.',
        default_value: 'By default, `AlwaysAllow` is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--authorization-mode` argument exists and is set to a value to include `Node`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261976'],
        attributes: {},
        baseScore: 5,
        impact_statement: 'None',
        default_value: 'By default, `Node` authorization is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--authorization-mode` argument exists and is set to a value to include `RBAC`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261981'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'When RBAC is enabled you will need to ensure that appropriate RBAC settings (including Roles, RoleBindings and ClusterRoleBindings) are configured to allow appropriate access.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--enable-admission-plugins` argument is set to a value that includes `EventRateLimit`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261984'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'You need to carefully tune in limits as per your environment.',
        default_value: 'By default, `EventRateLimit` is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that if the `--enable-admission-plugins` argument is set, its value does not include `AlwaysAdmit`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261991'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'Only requests explicitly allowed by the admissions control plugins would be served.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--enable-admission-plugins` argument is set to a value that includes `AlwaysPullImages`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261998'],
        attributes: {},
        baseScore: 4,
        category: {
          name: 'Control plane',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--disable-admission-plugins` argument is set to a value that does not includes `ServiceAccount`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262002'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'None.',
        default_value: 'By default, `ServiceAccount` is set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--disable-admission-plugins` argument is set to a value that does not include `NamespaceLifecycle`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262004'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'None',
        default_value: 'By default, `NamespaceLifecycle` is set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--enable-admission-plugins` argument is set to a value that includes `NodeRestriction`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262005'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, `NodeRestriction` is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--profiling` argument is set to `false`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262009'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'Profiling information would not be available.',
        default_value: 'By default, profiling is enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--audit-log-path` argument is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262011'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default, auditing is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--audit-log-maxage` argument is set to `30` or as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262015'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, auditing is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--audit-log-maxbackup` argument is set to `10` or as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262016'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, auditing is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--audit-log-maxsize` argument is set to `100` or as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262018'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, auditing is not enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--request-timeout` argument is either not set or set to an appropriate value.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262022'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, `--request-timeout` is set to 60 seconds.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that if the `--service-account-lookup` argument exists it is set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262023'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `--service-account-lookup` argument is set to `true`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--service-account-key-file` argument exists and is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262024'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          "The corresponding private key must be provided to the controller manager. You would need to securely maintain the key file and rotate the keys based on your organization's key rotation policy.",
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--etcd-certfile` and `--etcd-keyfile` arguments exist and they are set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262025'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'TLS and client certificate authentication must be configured for etcd.',
        default_value: 'By default, `--etcd-certfile` and `--etcd-keyfile` arguments are not set',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--tls-cert-file` and `--tls-private-key-file` arguments exist and they are set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262026'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'TLS and client certificate authentication must be configured for your Kubernetes cluster deployment.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--client-ca-file` argument exists and it is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262027'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'TLS and client certificate authentication must be configured for your Kubernetes cluster deployment.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--etcd-cafile` argument exists and it is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262028'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'TLS and client certificate authentication must be configured for etcd.',
        default_value: 'By default, `--etcd-cafile` is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--encryption-provider-config` argument is set to a `EncryptionConfig` file. Additionally, ensure that the `EncryptionConfig` file has all the desired `resources` covered especially any secrets.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262029'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default, `--encryption-provider-config` is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Get the `EncryptionConfig` file set for `--encryption-provider-config` argument. Verify that `aescbc`, `kms` or `secretbox` is set as the encryption provider for all the desired `resources`.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262030'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default, no encryption provider is set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--terminated-pod-gc-threshold` argument is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262032'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'By default, `--terminated-pod-gc-threshold` is set to `12500`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--profiling` argument is set to `false`.',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262033'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'Profiling information would not be available.',
        default_value: 'By default, profiling is enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--use-service-account-credentials` argument is set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262034'],
        attributes: {},
        baseScore: 4,
        category: {
          name: 'Control plane',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--service-account-private-key-file` argument is set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262035'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          "You would need to securely maintain the key file and rotate the keys based on your organization's key rotation policy.",
      ...
      },
      {
        ...
        manual_test:
          "Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--root-ca-file` argument exists and is set to a certificate bundle file containing the root certificate for the API server's serving certificate.",
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262036'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'You need to setup and maintain root certificate authority file.',
        default_value: 'By default, `--root-ca-file` is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that `RotateKubeletServerCertificate` argument exists and is set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262037'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-controller-manager\n\n```\n Verify that the `--bind-address` argument is set to 127.0.0.1',
        references: ['https://workbench.cisecurity.org/sections/2633397/recommendations/4262038'],
        attributes: {},
        baseScore: 5,
        impact_statement: 'None',
        default_value: 'By default, the `--bind-address` parameter is set to 0.0.0.0',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-scheduler\n\n```\n Verify that the `--profiling` argument is set to `false`.',
        references: ['https://workbench.cisecurity.org/sections/2633398/recommendations/4262039'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'Profiling information would not be available.',
        default_value: 'By default, profiling is enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-scheduler\n\n```\n Verify that the `--bind-address` argument is set to 127.0.0.1',
        references: ['https://workbench.cisecurity.org/sections/2633398/recommendations/4262040'],
        attributes: {},
        baseScore: 5,
        impact_statement: 'None',
        default_value: 'By default, the `--bind-address` parameter is set to 0.0.0.0',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the etcd server node\n\n \n```\nps -ef | grep etcd\n\n```\n Verify that the `--cert-file` and the `--key-file` arguments are set as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261916'],
        attributes: {},
        baseScore: 8,
        impact_statement: 'Client connections only over TLS would be served.',
        default_value: 'By default, TLS encryption is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the etcd server node:\n\n \n```\nps -ef | grep etcd\n\n```\n Verify that the `--client-cert-auth` argument is set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261919'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'All clients attempting to access the etcd server will require a valid client certificate.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the etcd server node:\n\n \n```\nps -ef | grep etcd\n\n```\n Verify that if the `--auto-tls` argument exists, it is not set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261921'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'Clients will not be able to use self-signed certificates for TLS.',
        default_value: 'By default, `--auto-tls` is set to `false`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the etcd server node:\n\n \n```\nps -ef | grep etcd\n\n```\n Verify that the `--peer-cert-file` and `--peer-key-file` arguments are set as appropriate.\n\n **Note:** This recommendation is applicable only for etcd clusters. If you are using only one etcd server in your environment then this recommendation is not applicable.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261925'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'etcd cluster peers would need to set up TLS for their communication.',
        category: {
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261928'],
        attributes: {},
        baseScore: 7,
        impact_statement:
          'All peers attempting to communicate with the etcd server will require a valid client certificate for authentication.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the etcd server node:\n\n \n```\nps -ef | grep etcd\n\n```\n Verify that if the `--peer-auto-tls` argument exists, it is not set to `true`.\n**Note:** This recommendation is applicable only for etcd clusters. If you are using only one etcd server in your environment then this recommendation is not applicable.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261930'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          'All peers attempting to communicate with the etcd server will require a valid client certificate for authentication.',
      ...
      },
      {
        ...
        manual_test:
          'Review the CA used by the etcd environment and ensure that it does not match the CA certificate file used for the management of the overall Kubernetes cluster.\n\n Run the following command on the master node:\n\n \n```\nps -ef | grep etcd\n\n```\n Note the file referenced by the `--trusted-ca-file` argument.\n\n Run the following command on the master node:\n\n \n```\nps -ef | grep apiserver\n\n```\n Verify that the file referenced by the `--client-ca-file` for apiserver is different from the `--trusted-ca-file` used by etcd.',
        references: ['https://workbench.cisecurity.org/sections/2633381/recommendations/4261932'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'Additional management of the certificates and keys for the dedicated certificate authority will be required.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on one of the cluster master nodes:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--audit-policy-file` is set. Review the contents of the file specified and ensure that it contains a valid audit policy.',
        references: ['https://workbench.cisecurity.org/sections/2633386/recommendations/4261938'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Audit logs will be created on the master nodes, which will consume disk space. Care should be taken to avoid generating too large volumes of log information as this could impact the available of the cluster nodes.',
      ...
      },
      {
        ...
        manual_test:
          'Review the audit policy provided for the cluster and ensure that it covers at least the following areas :-\n\n * Access to Secrets managed by the cluster. Care should be taken to only log Metadata for requests to Secrets, ConfigMaps, and TokenReviews, in order to avoid the risk of logging sensitive data.\n* Modification of `pod` and `deployment` objects.\n* Use of `pods/exec`, `pods/portforward`, `pods/proxy` and `services/proxy`.\n\n For most requests, minimally logging at the Metadata level is recommended (the most basic level of logging).',
        references: ['https://workbench.cisecurity.org/sections/2633386/recommendations/4261940'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Increasing audit logging will consume resources on the nodes or other log destination.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261937'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, the `kubelet` service file has permissions of `640`.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261945'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `kubelet` service file ownership is set to `root:root`.',
      ...
      },
      {
        ...
        manual_test:
          'Find the kubeconfig file being used by `kube-proxy` by running the following command:\n\n \n```\nps -ef | grep kube-proxy\n\n```\n If `kube-proxy` is running, get the kubeconfig file location from the `--kubeconfig` parameter.\n\n To perform the audit:\n\n Run the below command (based on the file location on your system) on the each worker node. For example,\n\n \n```\nstat -c %a <path><filename>\n\n```\n Verify that a file is specified and it exists with permissions are `600` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261954'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, proxy file has permissions of `640`.',
      ...
      },
      {
        ...
        manual_test:
          'Find the kubeconfig file being used by `kube-proxy` by running the following command:\n\n \n```\nps -ef | grep kube-proxy\n\n```\n If `kube-proxy` is running, get the kubeconfig file location from the `--kubeconfig` parameter.\n\n To perform the audit:\n\n Run the below command (based on the file location on your system) on the each worker node. For example,\n\n \n```\nstat -c %U:%G <path><filename>\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261955'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `proxy` file ownership is set to `root:root`.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261964'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `kubelet.conf` file has permissions of `600`.',
      ...
      },
      {
        ...
        manual_test:
          'Automated AAC auditing has been modified to allow CIS-CAT to input a variable for the <PATH>/<FILENAME> of the kubelet config file.\n\n Please set $kubelet\\_config=<PATH> based on the file location on your system\n\n for example:\n\n \n```\nexport kubelet_config=/etc/kubernetes/kubelet.conf\n\n```\n To perform the audit manually:\nRun the below command (based on the file location on your system) on the each worker node. For example,\n\n \n```\nstat -c %U:%G /etc/kubernetes/kubelet.conf\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261971'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, `kubelet.conf` file ownership is set to `root:root`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command:\n\n \n```\nps -ef | grep kubelet\n\n```\n Find the file specified by the `--client-ca-file` argument.\n\n Run the following command:\n\n \n```\nstat -c %a <filename>\n\n```\n Verify that the permissions are `644` or more restrictive.',
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261977'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default no `--client-ca-file` is specified.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command:\n\n \n```\nps -ef | grep kubelet\n\n```\n Find the file specified by the `--client-ca-file` argument.\n\n Run the following command:\n\n \n```\nstat -c %U:%G <filename>\n\n```\n Verify that the ownership is set to `root:root`.',
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261978'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value: 'By default no `--client-ca-file` is specified.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261979'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633385/recommendations/4261985'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'If using a Kubelet configuration file, check that there is an entry for `authentication: anonymous: enabled` set to `false`.\n\n Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that the `--anonymous-auth` argument is set to `false`.\n\n This executable argument may be omitted, provided there is a corresponding entry set to `false` in the Kubelet config file.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4261993'],
        attributes: {},
        baseScore: 7,
        impact_statement: 'Anonymous requests will be rejected.',
        default_value: 'By default, anonymous access is enabled.',
      ...
      },
      {
        ...
        manual_test:
          "Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n If the `--authorization-mode` argument is present check that it is not set to `AlwaysAllow`. If it is not present check that there is a Kubelet config file specified by `--config`, and that file sets `authorization: mode` to something other than `AlwaysAllow`.\n\n It is also possible to review the running configuration of a Kubelet via the `/configz` endpoint on the Kubelet API port (typically `10250/TCP`). Accessing these with appropriate credentials will provide details of the Kubelet's configuration.",
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262001'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'Unauthorized requests will be denied.',
        default_value: 'By default, `--authorization-mode` argument is set to `AlwaysAllow`.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that the `--client-ca-file` argument exists and is set to the location of the client certificate authority file.\n\n If the `--client-ca-file` argument is not present, check that there is a Kubelet config file specified by `--config`, and that the file sets `authentication: x509: clientCAFile` to the location of the client certificate authority file.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262003'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'You require TLS to be configured on apiserver as well as kubelets.',
        default_value: 'By default, `--client-ca-file` argument is not set.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that the `--read-only-port` argument exists and is set to `0`.\n\n If the `--read-only-port` argument is not present, check that there is a Kubelet config file specified by `--config`. Check that if there is a `readOnlyPort` entry in the file, it is set to `0`.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262006'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'Removal of the read-only port will require that any service which made use of it will need to be re-configured to use the main Kubelet API.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that the `--streaming-connection-idle-timeout` argument is not set to `0`.\n\n If the argument is not present, and there is a Kubelet config file specified by `--config`, check that it does not set `streamingConnectionIdleTimeout` to 0.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262007'],
        attributes: {},
        baseScore: 3,
        impact_statement: 'Long-lived connections could be interrupted.',
        default_value: 'By default, `--streaming-connection-idle-timeout` is set to 4 hours.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that if the `--make-iptables-util-chains` argument exists then it is set to `true`.\n\n If the `--make-iptables-util-chains` argument does not exist, and there is a Kubelet config file specified by `--config`, verify that the file does not set `makeIPTablesUtilChains` to `false`.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262008'],
        attributes: {},
        baseScore: 3,
        impact_statement:
          'Kubelet would manage the iptables on the system and keep it in sync. If you are using any other iptables management solution, then there might be some conflicts.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that `--hostname-override` argument does not exist.\n\n **Note** This setting is not configurable via the Kubelet config file.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262010'],
        attributes: {},
        baseScore: 3,
        impact_statement:
          'Some cloud providers may require this flag to ensure that hostname matches names issued by the cloud provider. In these environments, this recommendation should not apply.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262012'],
        attributes: {},
        baseScore: 2,
        impact_statement:
          "Setting this parameter to `0` could result in a denial of service condition due to excessive events being created. The cluster's event processing and storage systems should be scaled to handle expected event loads.",
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that the --tls-cert-file and --tls-private-key-file arguments exist and they are set as appropriate.\n\n If these arguments are not present, check that there is a Kubelet config specified by --config and that it contains appropriate settings for tlsCertFile and tlsPrivateKeyFile.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262013'],
        attributes: {},
        baseScore: 7,
        impact_statement: '',
        default_value: '',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262014'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, kubelet client certificate rotation is enabled.',
      ...
      },
      {
        ...
        manual_test:
          'Ignore this check if serverTLSBootstrap is true in the kubelet config file or if the --rotate-server-certificates parameter is set on kubelet\n\n Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n Verify that `RotateKubeletServerCertificate` argument exists and is set to `true`.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262017'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'None',
        default_value: 'By default, kubelet server certificate rotation is enabled.',
      ...
      },
      {
        ...
        manual_test:
          'The set of cryptographic ciphers currently considered secure is the following:\n\n * `TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256`\n* `TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256`\n* `TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305`\n* `TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384`\n* `TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305`\n* `TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384`\n* `TLS_RSA_WITH_AES_256_GCM_SHA384`\n* `TLS_RSA_WITH_AES_128_GCM_SHA256`\n\n Run the following command on each node:\n\n \n```\nps -ef | grep kubelet\n\n```\n If the `--tls-cipher-suites` argument is present, ensure it only contains values included in this set.\n\n If it is not present check that there is a Kubelet config file specified by `--config`, and that file sets `TLSCipherSuites:` to only include values from this set.',
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262019'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Kubelet clients that cannot support modern cryptographic ciphers will not be able to make connections to the Kubelet API.',
      ...
      },
      {
        ...
        manual_test:
          'Obtain a list of the principals who have access to the `cluster-admin` role by reviewing the `clusterrolebinding` output for each role binding that has access to the `cluster-admin` role.\n\n \n```\nkubectl get clusterrolebindings -o=custom-columns=NAME:.metadata.name,ROLE:.roleRef.name,SUBJECT:.subjects[*].name\n\n```\n Review each principal listed and ensure that `cluster-admin` privilege is required for it.',
        test: 'Check which subjects have are bound to the cluster-admin role with a clusterrolebinding.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261941'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'Care should be taken before removing any `clusterrolebindings` from the environment to ensure they were not required for operation of the cluster. Specifically, modifications should not be made to `clusterrolebindings` with the `system:` prefix as they are required for the operation of system components.',
      ...
      },
      {
        ...
        manual_test:
          'Review the users who have `get`, `list` or `watch` access to `secrets` objects in the Kubernetes API.',
        test: 'Check which subjects have RBAC permissions to get, list or watch Kubernetes secrets.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261943'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          'Care should be taken not to remove access to secrets to system components which require this for their operation',
      ...
      },
      {
        ...
        manual_test:
          'Retrieve the roles defined across each namespaces in the cluster and review for wildcards\n\n \n```\nkubectl get roles --all-namespaces -o yaml\n\n```\n Retrieve the cluster roles defined in the cluster and review for wildcards\n\n \n```\nkubectl get clusterroles -o yaml\n\n```',
        test: 'Check which subjects have wildcard RBAC permissions.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261944'],
        attributes: {},
        baseScore: 7,
        impact_statement: '',
        default_value: '',
      ...
      },
      {
        ...
        manual_test:
          'Review the users who have create access to pod objects in the Kubernetes API.',
        test: 'Check which subjects have RBAC permissions to create pods.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261947'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Care should be taken not to remove access to pods to system components which require this for their operation',
      ...
      },
      {
        ...
        manual_test:
          'For each namespace in the cluster, review the rights assigned to the default service account and ensure that it has no roles or cluster roles bound to it apart from the defaults.\n\n Additionally ensure that the `automountServiceAccountToken: false` setting is in place for each default service account.',
        test: "Checks that each namespace has at least one service account that isn't the default, and checks that the default service accounts have 'automountServiceAccountToken: false' set",
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261950'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'All workloads which require access to the Kubernetes API will require an explicit service account to be created.',
      ...
      },
      {
        ...
        manual_test:
          'Review pod and service account objects in the cluster and ensure that the option below is set, unless the resource explicitly requires this access.\n\n \n```\nautomountServiceAccountToken: false\n\n```',
        test: 'Check that all service accounts and workloads disable automount of service account tokens.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261953'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Pods mounted without service account tokens will not be able to communicate with the API server, except where the resource is available to unauthenticated principals.',
      ...
      },
      {
        ...
        manual_test:
          'Review the users who have access to cluster roles or roles which provide the impersonate, bind or escalate privileges.',
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261957'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          'There are some cases where these permissions are required for cluster service operation, and care should be taken before removing these permissions from system service accounts.',
      ...
      },
      {
        ...
        test: 'Checks that every namespace enabled pod security admission, or if there are external policies applied for namespaced resources (validating/mutating webhooks)',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261966'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'Where policy control systems are in place, there is a risk that workloads required for the operation of the cluster may be stopped from running. Care is required when implementing admission control policies to ensure that this does not occur.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261967'],
        attributes: {},
        baseScore: 8,
        impact_statement:
          'Pods defined with `spec.containers[].securityContext.privileged: true`, `spec.initContainers[].securityContext.privileged: true` and `spec.ephemeralContainers[].securityContext.privileged: true` will not be permitted.',
      ...
      },
      {
        ...
        manual_test:
          "List the policies in use for each namespace in the cluster, ensure that each policy disallows the admission of containers which allow privilege escalation.\nTo fetch hostNetwork from each pod.\n\n `get pods -A -o=jsonpath=$'{range .items[*]}{@.metadata.name}: {@..securityContext}\\n{end}'`",
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261974'],
        attributes: {},
        baseScore: 6,
        impact_statement:
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that each policy restricts the use of root containers by setting `MustRunAsNonRoot` or `MustRunAs` with the range of UIDs not including 0.',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261975'],
        attributes: {},
        baseScore: 6,
        impact_statement: 'Pods with containers which run as the root user will not be permitted.',
        default_value:
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that at least one policy disallows the admission of containers with the `NET_RAW` capability.',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261980'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          'Pods with containers which run with the NET\\_RAW capability will not be permitted.',
      ...
      },
      {
        ...
        manual_test:
          "Ensure that allowedCapabilities is not present in policies for the cluster unless it is set to an empty array.\n\n \n```\nget pods -A -o=jsonpath=$'{range .items[*]}{@.metadata.name}: {@..securityContext}\\n{end}'\n\n```",
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261982'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Pods with containers which require capabilities outwith the default set will not be permitted.',
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that at least one policy requires that capabilities are dropped by all containers.',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261983'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Pods with containers require capabilities to operate will not be permitted.',
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that each policy disallows the admission of `hostProcess` containers',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261986'],
        attributes: {},
        baseScore: 7,
        impact_statement:
          'Pods defined with `securityContext.windowsOptions.hostProcess: true` will not be permitted unless they are run under a specific policy.',
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that each policy disallows the admission of containers with `hostPath` volumes.',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261987'],
        attributes: {},
        baseScore: 6,
        impact_statement:
          'Pods defined which make use of `hostPath` volumes will not be permitted unless they are run under a spefific policy.',
      ...
      },
      {
        ...
        manual_test:
          'List the policies in use for each namespace in the cluster, ensure that each policy disallows the admission of containers which have `hostPort` sections.',
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261988'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'Pods defined with `hostPort` settings in either the container, initContainer or ephemeralContainer sections will not be permitted unless they are run under a specific policy.',
      ...
      },
      {
        ...
        manual_test:
          'Review the documentation of CNI plugin in use by the cluster, and confirm that it supports Ingress and Egress network policies.',
        references: ['https://workbench.cisecurity.org/sections/2633391/recommendations/4261989'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value: 'This will depend on the CNI plugin in use.',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command and review the `NetworkPolicy` objects created in the cluster.\n\n \n```\nkubectl get networkpolicy --all-namespaces\n\n```\n Ensure that each namespace defined in the cluster has at least one Network Policy.',
        test: 'Check for each namespace if there is a network policy defined.',
        references: ['https://workbench.cisecurity.org/sections/2633391/recommendations/4261990'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'Once network policies are in use within a given namespace, traffic not explicitly allowed by a network policy will be denied. As such it is important to ensure that, when introducing network policies, legitimate traffic is not blocked.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command to find references to objects which use environment variables defined from secrets.\n\n \n```\nkubectl get all -o jsonpath=\'{range .items[?(@..secretKeyRef)]} {.kind} {.metadata.name} {"\\n"}{end}\' -A\n\n```',
        test: 'Check if pods have secrets in their environment variables',
        references: ['https://workbench.cisecurity.org/sections/2633392/recommendations/4261992'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'Application code which expects to read secrets in the form of environment variables would need modification',
      ...
      },
      {
        ...
        manual_test: 'Review your secrets management implementation.',
        test: 'Checking encryption configuration to see if secrets are managed externally by kms using aws, azure, or akeyless vault',
        references: ['https://workbench.cisecurity.org/sections/2633392/recommendations/4261994'],
        attributes: {},
        baseScore: 5,
        category: {
          name: 'Control plane',
      ...
      },
      {
        ...
        manual_test:
          'Run the below command and review the namespaces created in the cluster.\n\n \n```\nkubectl get namespaces\n\n```\n Ensure that these namespaces are the ones you need and are adequately administered as per your requirements.',
        test: 'Lists all namespaces in cluster for user to review',
        references: ['https://workbench.cisecurity.org/sections/2633395/recommendations/4261996'],
        attributes: {},
        baseScore: 5,
        impact_statement: 'You need to switch between namespaces for administration.',
        category: {
      ...
      },
      {
        ...
        manual_test:
          'Review the pod definitions in your cluster. It should create a line as below:\n\n \n```\n  securityContext:\n    seccompProfile:\n      type: RuntimeDefault\n\n```',
        test: 'Checks if seccomp profile is defined as type RuntimeDefault in security context of workload or container level',
        references: ['https://workbench.cisecurity.org/sections/2633395/recommendations/4261997'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'If the `docker/default` seccomp profile is too restrictive for you, you would have to create/manage your own seccomp profiles.',
      ...
      },
      {
        ...
        manual_test:
          'Review the pod definitions in your cluster and verify that you have security contexts defined as appropriate.',
        references: ['https://workbench.cisecurity.org/sections/2633395/recommendations/4261999'],
        attributes: {
          controlTypeTags: ['security', 'compliance'],
          attackTracks: [
            {
      ...
      },
      {
        ...
        manual_test:
          'Run this command to list objects in default namespace\n\n \n```\nkubectl get $(kubectl api-resources --verbs=list --namespaced=true -o name | paste -sd, -) --ignore-not-found -n default\n\n```\n The only entries there should be system managed resources such as the `kubernetes` service',
        test: 'Lists all resources in default namespace for user to review and approve.',
        references: ['https://workbench.cisecurity.org/sections/2633395/recommendations/4262000'],
        attributes: {},
        baseScore: 4,
        impact_statement: 'None',
        default_value:
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261968'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Pods defined with `spec.hostPID: true` will not be permitted unless they are run under a specific policy.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633390/recommendations/4261969'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'Pods defined with `spec.hostIPC: true` will not be permitted unless they are run under a specific policy.',
      ...
      },
      {
        ...
        manual_test:
          'Run the following command on the Control Plane node:\n\n \n```\nps -ef | grep kube-apiserver\n\n```\n Verify that the `--tls-cipher-suites` argument is set as outlined in the remediation procedure below.',
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4262031'],
        attributes: {},
        baseScore: 5,
        impact_statement:
          'API server clients that cannot support modern cryptographic ciphers will not be able to make connections to the API server.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261959'],
        attributes: {},
        baseScore: 5,
        impact_statement: '',
        category: {
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261961'],
        attributes: {},
        baseScore: 5,
        impact_statement: '',
        category: {
      ...
      },
      {
        ...
        controlID: 'C-0280',
        description:
          'Users with access to the update the `approval` sub-resource of `certificateaigningrequests` objects can approve new client certificates for the Kubernetes API effectively allowing them to create new high-privileged user accounts.\n\n This can allow for privilege escalation to full cluster administrator, depending on users configured in the cluster',
        ...
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261962'],
        attributes: {},
        baseScore: 5,
        impact_statement: '',
        category: {
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261963'],
        attributes: {},
        baseScore: 5,
        impact_statement: '',
        category: {
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633388/recommendations/4261965'],
        attributes: {},
        baseScore: 5,
        impact_statement: '',
        category: {
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633389/recommendations/4261958'],
        attributes: {},
        baseScore: 4,
        impact_statement:
          'When enabled, users of the cluster may not create new Services which use externalIPs and may not add new values to externalIPs on existing Service objects.',
      ...
      },
      {
        ...
        references: ['https://workbench.cisecurity.org/sections/2633393/recommendations/4262020'],
        attributes: {},
        baseScore: 2,
        impact_statement:
